...
new class extends Component {
    ...
    public function confirmDelete($roleId)
    {
        try {
            ...
            \Log::info('roleToDelete: ' . ($this->roleToDelete ? $this->roleToDelete->name : 'null'));
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <div
                    ...
                    <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                        <div class="flex items-start justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ $role->name }}
                                    </h3>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div class="text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-xl">
                                <div class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $role->users_count
                                    ??
                                    0 }}</div>
                                <div class="text-xs text-green-600 dark:text-green-400 font-medium">{{ __('Users') }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Users')
                                    }}</span>
                ...
                <div class="col-span-full">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-12 text-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ __('No roles found') }}
                        </h3>
                        <p class="text-gray-600 dark:text-gray-400 mb-6">{{ __('Get started by creating a new role.') }}
                        </p>
                        <a href="{{ route('role.create') }}"
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    ...
                                    {{ __('Are you sure you want to delete the role') }} <strong
                                        class="text-gray-900 dark:text-white">{{ $roleToDelete->name }}</strong>? {{
                                    __('This
