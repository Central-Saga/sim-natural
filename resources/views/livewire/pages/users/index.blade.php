...
#[Layout('components.layouts.app')]
    ...
    {
        try {
            \Log::info('Confirm delete called for user ID: ' . $userId);
            ...
            \Log::info('userToDelete: ' . ($this->userToDelete ? $this->userToDelete->name : 'null'));
                    ...
                    <div class="p-6">
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-xs font-medium text-gray-600 dark:text-gray-400 truncate">{{ __('No
                                    roles
                                    assigned') }}</span>
                            </div>
                        </div>
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    ...
                                    {{ __('Are you sure you want to delete the user') }} <strong
                                        class="text-gray-900 dark:text-white">{{ $userToDelete->name }}</strong>? {{
                                    __('This
