...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable
        class="border-e border-emerald-200 bg-gradient-to-b from-emerald-500 to-emerald-600 dark:border-emerald-700 text-white">
        ...
        <flux:dropdown position="bottom" align="start">
            <flux:profile :name="auth()->user()->name" :initials="auth()->user()->initials()"
                icon-trailing="chevrons-up-down" class="!text-white" icon-class="!text-white"
                icon-style="fill:white;color:white" />
